...
export const NAV_ITEMS: NavItemDef[] = [
  ...
  { id: "second-chance", path: "second-chance", labelKey: "secondChance", visibility: "public", header: true, footer: true, mobile: true },
  { id: "daily", path: "daily", labelKey: "daily", visibility: "auth", header: true, footer: true, mobile: true },
  { id: "crowd", path: "crowd", labelKey: "crowd", visibility: "public", header: false, footer: true, mobile: false },
  { id: "recap", path: "recap", labelKey: "recap", visibility: "public", header: false, footer: true, mobile: false },
  { id: "missions", path: "missions", labelKey: "missions", visibility: "auth", header: false, footer: true, mobile: false },
