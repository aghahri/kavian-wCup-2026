...
export default async function AdminLanguagesPage({ params }: PageProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-black text-white">{t("languages")}</h1>
          <p className="mt-1 text-sm text-white/70">{t("languagesDesc")}</p>
        </div>
      ...
      <AdminLanguageManager initialTranslations={translations} />
    </div>
  );
}
